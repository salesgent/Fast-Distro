    ...
    return (
      ...
      >
        <div style={{ maxWidth: "1475px", margin: "auto" }}>
          {/* <p style={{ fontSize: "45px", fontWeight: 700, color: "#ffffff", marginBottom: "2rem", textAlign: "center" }}>
            Shop by Category
          </p> */}
          <SwiperContainer
            spaceBetween={20}
