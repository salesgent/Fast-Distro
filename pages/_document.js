...
export default class Document extends NextDocument {
  ...
  render() {
    ...
    // Bump this when the logo changes so WhatsApp/Facebook fetch a fresh preview.
    const ogImageVersion = "2026-05-19";
    const ogImageUrl = `${siteUrl}/images/header/logo.png?v=${ogImageVersion}`;
    return (
      <Html lang="en" dir="ltr">
        <Head>
          ...
          <link
            ...
            rel="stylesheet"
          />
          {/* og images — absolute URL + version breaks WhatsApp preview cache */}
          <meta property="og:title" content="Fast Distro" />
